...
CREATE TABLE material_settings (
  ...
  machining_coefficient DECIMAL(10,4) default 1.0,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
('machining_cost_per_minute', '{"value": 150000}', 'هزینه هر دقیقه ماشینکاری (ریال)'),
...
('max_depth_of_cut', '{"value":3}', حداکثر عمق باربرداری هر پاس (میلی متر));

-- Insert default materials
INSERT INTO material_settings (material_name, material_name_fa, cutting_speed, feed_rate, density, cost_per_kg, machining_coefficient ) VALUES
('CK45', 'CK45', 120, 0.25, 7.85, 25000, 1.0),
('ST37', 'ST37', 150, 0.30, 7.85, 20000, 0.9),
('Mo40', 'Mo40', 80, 0.15, 7.85, 35000, 1.2),
('SS304', 'استیل 304', 60, 0.12, 8.00, 80000, 1.5),
('SS316', 'استیل 316', 50, 0.10, 8.00, 90000, 1.7),
('Aluminum', 'آلومینیوم', 200, 0.35, 2.70, 50000, 0.7),
('Brass', 'برنج', 150, 0.30, 8.50, 100000, 0.8),
('PhosphorBronze', 'فسفر برنز', 100, 0.20, 8.80, 150000, 1.3),
('CastIron', 'چدن', 70, 0.15, 7.20, 15000, 1.5),
('Other', 'سایر', 100, 0.20, 7.85, 30000, 1.0);
...
('metric', 'متریک', 1.4, 0.5),
('inch', 'اینچی', 1.6, 0.6),
('trapezoidal', 'کبریتی', 1.8, 0.8);
