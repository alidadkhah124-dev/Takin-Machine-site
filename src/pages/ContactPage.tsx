      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-bold text-navy-900 mb-4">تماس با ما</h1>
          ...
          <div className="bg-gradient-to-l from-navy-800 to-navy-900 rounded-2xl p-6 mb-12 text-white">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold">ساعات کاری</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-300">
              <div className="flex justify-between">
                <span>شنبه - چهارشنبه</span>
                <span className="text-white font-medium">۸:۰۰ - ۱۷:۰۰</span>
              </div>
              <div className="flex justify-between">
                <span>پنجشنبه</span>
                <span className="text-white font-medium">۸:۰۰ - ۱۳:۰۰</span>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="p-6">
              {submitted && (
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
                  ...
                  <span className="text-green-700">پیام شما با موفقیت ارسال شد. به زودی با شما تماس می‌گیریم.</span>
                </div>
              )}
          ...
          <div className="mt-8 bg-gray-200 rounded-2xl h-64 flex items-center justify-center">
            <div className="text-center text-gray-500">
              ...
              <p>اصفهان، خیابان حکیم، فرزانه صنعتگران ۳۷</p>
            </div>
          </div>
        </div>
      </div>
